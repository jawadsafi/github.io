var amountOfSide = parseFloat(prompt("Hello There!, Jazzy Jaguar Enterprise welcomes! To Start, Please input the number of sides from 0-10 to find out the name polygon"));
...
function getShape(sides) 
{
    ...
    switch (sides) 
    {
        case 0:
            ...
            break;
        case 1:
            return "This polygon with 1 side is a Hexagon";
            break;
        case 2:
